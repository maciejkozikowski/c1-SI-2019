    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region minimalne i maksymalne wartości poszczególnych atrybutów(dotyczy atrybutów numerycznych) 
                ...
                int[] tab=new int[wczytaneDane.Count() - 1];

                for (int i = 0; i < wczytaneDane.Count()-1; i++)//zamienia stringi na liczby do tablicy
                {
                ...
                int tmp;
                for (int i = 0; i < tab.Length- 1; i++)//sortuje tablice
                {
                ...
                Console.WriteLine("Min to: " + tab[0] + "Max to: " + tab[tab.Length - 1]);
